    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h3 className="text-lg font-semibold mb-2">프롬프트 관리</h3>
                    <p className="text-sm text-muted-foreground">
                        AI가 제품을 처리하는 방식을 사용자 정의하세요.
                    </p>
                </div>
                ...
                {FILTER_TABS.map(tab => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all border ${activeFilter === tab.key
                            ...
                            : 'bg-muted border-border text-muted-foreground hover:bg-muted/50 hover:text-foreground'
                            }`}
                    >
            ...
            {isLoading ? (
                <div className="text-muted-foreground">프롬프트 로딩 중...</div>
