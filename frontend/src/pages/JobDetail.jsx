...
const statusConfig = {
    ...
    cancelled: {
        label: '취소됨',
        color: 'text-gray-400 bg-gray-400/10 border-gray-500/20',
        icon: Ban
    }
};
        ...
        return (
            <Layout>
                <div className="text-center py-12">
                    ...
                    <h2 className="text-xl font-semibold text-white mb-2">작업을 찾을 수 없습니다</h2>
            ...
            >
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold text-white">작업 상세 정보</h1>
                        <p className="text-gray-400 mt-2">실시간 진행 상황을 확인하세요</p>
                    </div>
                    ...
                    <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400 mt-1">작업 ID: {job.id.slice(0, 8)}...</p>
                            </div>
                        </div>
                        <div className={cn(
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {job.status === 'processing' && currentStep && (
                        <Card className="border-blue-500/30 bg-blue-500/5">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-semibold text-white">현재 진행 상황</h3>
                            </div>
                            <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-400">처리 중인 행</span>
                                    <span className="text-white font-medium">{currentRow} / {totalRows}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-400">완료된 행</span>
                                    <span className="text-white font-medium">{rowsProcessed}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                ...
                                {estimatedSeconds > 0 && (
                                    <div className="flex justify-between items-center pt-2 border-t border-white/10">
                                        ...
                                        <span className="text-green-400 font-medium">{formatDuration(estimatedSeconds)}</span>
                                    </div>
                                )}
                            </div>
                        </Card>
                    ...
                    <Card className="border-white/10">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-white">작업 정보</h3>
                        </div>
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                <span className="text-gray-400">생성 시간</span>
                                <span className="text-white text-sm">{formatDate(job.created_at)}</span>
                            </div>
                            {metaData.processing_started_at && (
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-400">처리 시작</span>
                                    <span className="text-white text-sm">{formatDate(metaData.processing_started_at)}</span>
                                </div>
                            )}
                            {metaData.last_updated && job.status === 'processing' && (
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-400">마지막 업데이트</span>
                                    <span className="text-white text-sm">{formatDate(metaData.last_updated)}</span>
                                </div>
                            )}
                ...
                {metaData.column_mapping && (
                    <Card className="border-white/10">
                        <h3 className="text-lg font-semibold text-white mb-4">열 매핑 설정</h3>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="bg-white/5 rounded-lg p-3">
                                <p className="text-xs text-gray-400 mb-1">원본 상품명</p>
                                <p className="text-white font-medium">{metaData.column_mapping.original_product_name}열</p>
                            </div>
                            <div className="bg-white/5 rounded-lg p-3">
                                <p className="text-xs text-gray-400 mb-1">가공된 상품명</p>
                                <p className="text-white font-medium">{metaData.column_mapping.refined_product_name}열</p>
                            </div>
                            <div className="bg-white/5 rounded-lg p-3">
                                <p className="text-xs text-gray-400 mb-1">키워드</p>
                                <p className="text-white font-medium">{metaData.column_mapping.keyword}열</p>
                            </div>
                            <div className="bg-white/5 rounded-lg p-3">
                                <p className="text-xs text-gray-400 mb-1">카테고리</p>
                                <p className="text-white font-medium">{metaData.column_mapping.category}열</p>
                            </div>
                        </div>
                    </Card>
                )}
                ...
                {job.status === 'cancelled' && (
                    <Card className="border-gray-500/30 bg-gray-500/5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-gray-400">작업 취소됨</h3>
                    ...
                    <Card className="border-green-500/30 bg-green-500/5">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-green-400">처리 완료!</h3>
                                    <p className="text-green-300 text-sm mt-1">결과 파일을 다운로드할 수 있습니다</p>
                                </div>
                            </div>
                            <Button
                    ...
                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-white">작업 취소</h3>
                            </div>
